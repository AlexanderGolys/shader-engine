...
function m.generate(prj)
	...
	for cfg in project.eachconfig(prj) do
		...
		for a, link in ipairs(config__.getlinks(cfg, "dependencies", "object")) do
		...
		for _, link in ipairs(config__.getlinks(cfg, "system", "fullpath")) do
		...
		if (dialect ~= nil and dialect ~= '') or dialect == 'Default' then
			local standard = {}
			standard["C++98"] = 98
			standard["C++11"] = 11
			standard["C++14"] = 14
