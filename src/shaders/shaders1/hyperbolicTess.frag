...
void main()
{
	color = colorFactorFromSingleLight(light1, camPosition, v_position, v_normal) +
			colorFactorFromSingleLight(light2, camPosition, v_position, v_normal) +
			colorFactorFromSingleLight(light3, camPosition, v_position, v_normal);
