...
vec4 colorFactorFromSingleLight(mat4 mat, mat4 light, vec3 camPos, vec3 pos, vec3 n)
{
	...
	return ambientColor(mat) * ambientIntencity(mat)/3. + 
...
void main()
{
	...
	color = colorFactorFromSingleLight(material, light1, camPosition, v_position, v_normal) +
			colorFactorFromSingleLight(material, light2, camPosition, v_position, v_normal) +
			colorFactorFromSingleLight(material, light3, camPosition, v_position, v_normal);
}